...
train_label = 'modelParamMask/train.csv'
val_label = 'modelParamMask/val.csv'
...
def get_detr_model(num_classes):
    model = detection.detr_resnet50(pretrained=True)
    # Ersetze den Box-Kopf mit der Anzahl der Klassen
