...
# Pfade
image_dir = 'rsna-pneumonia-dataset2/stage_2_train_images'
label_csv = 'rsna-pneumonia-dataset2/stage_2_train_labels.csv'
checkpoint_dir = './checkpointsEff/'
history_file = 'history.txt'
split_info_path = './split_info_Eff.pth'
...
# Initialisiere das Modell (EfficientNet-B0)
def initialize_model():
    # resnet18 = models.resnet18(pretrained=True)
    # resnet34 = models.resnet34(pretrained=True)
    # model = models.resnet101(pretrained=True)
    # model = models.densenet121(weights='DEFAULT')  # Verwenden Sie 'weights' anstelle von 'pretrained'
    model = models.efficientnet_b0(weights='DEFAULT')  # EfficientNet-B0 verwenden

    num_features = model.classifier[1].in_features
    model.classifier[1] = nn.Linear(num_features, 2)  # 2 Klassen (Pneumonia / Normal)
